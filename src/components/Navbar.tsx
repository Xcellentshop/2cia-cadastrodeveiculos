...
import { Car, FileText, Search, PlusCircle, LogOut, Sun, Moon, Package, Home, List, Shield } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center space-x-8">
            ...
            {isPersonnelSection && (
              <>
                ...
                <Link to="/personnel/new" className="flex items-center space-x-1 hover:text-indigo-200 transition">
                  <PlusCircle className="h-5 w-5" />
                  <span>Cadastrar</span>
                </Link>
                <Link to="/personnel/sectors" className="flex items-center space-x-1 hover:text-indigo-200 transition">
                  <Package className="h-5 w-5" />
                  <span>Setores</span>
                </Link>
                <Link to="/personnel/reports" className="flex items-center space-x-1 hover:text-indigo-200 transition">
                  <FileText className="h-5 w-5" />
                  <span>Relatório</span>
                </Link>
              </>
          ...
          <div className="flex items-center space-x-4">
            {!isVehicleSection && !isAssetSection && !isCalendarSection && !isPersonnelSection && (
              <>
                ...
                <Link to="/personnel" className="flex items-center space-x-1 hover:text-indigo-200 transition">
