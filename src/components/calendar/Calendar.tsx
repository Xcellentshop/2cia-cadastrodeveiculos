      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        <div className="lg:col-span-3 bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          <FullCalendar
            ...
            dayCellClassNames={isDark ? 'dark-cell' : ''}
            dayHeaderClassNames={isDark ? 'dark-header' : ''}
            slotLabelClassNames={isDark ? 'dark-label' : ''}
            eventClassNames={isDark ? 'dark-event' : ''}
            viewClassNames={isDark ? 'dark-view' : ''}
            titleFormat={{ year: 'numeric', month: 'long' }}
            titleClassNames={isDark ? 'dark-title' : ''}
            toolbarClassNames={{
              title: isDark ? 'dark-month-title' : ''
            }}
          />
        </div>
